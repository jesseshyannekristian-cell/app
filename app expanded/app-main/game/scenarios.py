...
SCENARIOS = {
    ...
    "SCP-105": [
        {"prompt": "SCP-105 has slipped her hand through a photograph, arm vanishing at the wrist.",
         "options": [
             ("Call her back before she steps fully through", 12, "She hesitates, then withdraws her arm. Contact holds."),
             ("Try to grab her before she disappears", -16, "You grab air. She's already stepped through the frame."),
         ]},
        {"prompt": "Something on the other side of the photo is pulling at the connection.",
         "options": [
             ("Destroy the photograph to sever the link", 13, "The print burns. Whatever it was, it can't follow."),
             ("Reach through after her", -20, "Your hand meets something cold on the other side."),
         ]},
    ],
    "SCP-2000": [
        {"prompt": "The contingency machine is spinning up on its own, activation codes bypassed.",
         "options": [
             ("Force a manual shutdown at the console", 14, "You cut power at the source. The spin-up halts."),
             ("Pull the site-wide breaker", -14, "The lights die — and so does your control over what happens next."),
         ]},
        {"prompt": "A secondary failsafe is now demanding the multi-signature code.",
         "options": [
             ("Radio Command for the authorisation code", 12, "The code comes through. The machine stands down."),
             ("Guess the sequence yourself", -22, "Wrong code. Something deep below the facility stirs."),
         ]},
    ],
}
