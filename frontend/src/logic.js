...
// ---- breach ----
export function breachAssess(boot, s, threat) {
  let loadoutBonus = 0;
  const lines = [];
  ...
  const chance = clamp(base + rankBonus + loadoutBonus + diffMod, 10, 95);
  return { base, rankBonus, loadoutBonus, diffMod, chance, lines };
}
