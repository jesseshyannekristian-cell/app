...
LOADOUT_BONUS = {
    ...
    "riot_shield": (9, "Riot shield deflects a lunging strike."),
    "sedative_darts": (10, "A sedative dart drops the hostile before it closes distance."),
    "bio_foam": (8, "Biohazard foam seals off the contamination spread."),
    "emp_charge": (13, "EMP charge shorts out the anomaly's electronics mid-surge."),
    "antimemetic_agent": (11, "The suppressant keeps the entity from slipping from memory unnoticed."),
}
